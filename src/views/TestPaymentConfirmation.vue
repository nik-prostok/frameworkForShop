<template>
    <div class="testpaymentconfirmation">
        ...
        <button @click="createPayment">Начать оплату</button>
        <hr>
        <div v-if="payment" class="pay">
            ...
            <button @click="payPayment">Оплатить (происходит на сайте эквайринга, тут для теста)</button><br>
            <button @click="notPayPayment">Не оплатить (происходит на сайте эквайринга, тут для теста)</button>
        </div>
    </div>
</template>
